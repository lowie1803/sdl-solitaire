...
*Open the project:*<br>
Run Code::Blocks, and open the project in `sdl-solitaire-2215/build/codeblocks`.<br>
Finally, build and run the project.
...
cd sdl-solitaire-2215
mkdir ../eclipse-sdl-solitaire-2215
cd ../eclipse-sdl-solitaire-2215

# Generate an Eclipse project
cmake ../sdl-solitaire-2215 -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-sdl-solitaire-2215`.<br>
